...
class BasicBlock(nn.Module):
    def __init__(self, in_channels: int, out_channels: int, stride: int, drop_rate: float = 0.0,
                 activate_before_residual: bool = False, batch_norm_momentum: float = 0.001):
        super().__init__()
...
class NetworkBlock(nn.Module):
    def __init__(self, in_channels: int, out_channels: int, num_blocks: int, stride: int, drop_rate: float = 0.0,
                 activate_before_residual: bool = False, basic_block: type(BasicBlock) = BasicBlock, **block_kwargs):
        super().__init__()
    ...
    @staticmethod
    def _make_layer(block: type(BasicBlock), in_channels: int, out_channels: int, num_blocks: int, stride: int,
                    drop_rate: float, activate_before_residual: bool, **block_kwargs) -> nn.Module:
        layers = []
...
class WideResNet(nn.Module):
    def __init__(self, in_channels: int, out_channels: int, depth: int = 28, widening_factor: int = 2,
                 base_channels: int = 16, drop_rate: float = 0.0, batch_norm_momentum: float = 0.001):
        super().__init__()
