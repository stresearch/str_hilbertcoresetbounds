...
python3 coreset_calc_script.py -m StrMnist -c 500 -e bound_calculation/example_bound/hess.npy -l bound_calculation/example_bound/sample_loc/ --sigma-prior 0.0001 -j 10 -n 5 -k . -g 0 -r bound_calculation/example_bound/test_results.npz -o Debug
